...
class GoodsSpider:
    ...
    def spider_goods(self, page):
        ...
        search_url = 'https://s.taobao.com/search?q=%E6%83%85%E8%B6%A3%E5%86%85%E8%A1%A3&imgfile=&js=1&stats_click=search_radio_all%3A1&initiative_id=staobaoz_20200104&ie=utf8&bcoffset=4&p4ppushleft=1%2C48&ntoffset=4&'+'s='+str(pagenum)
        ...
        proxies = {'http': '119.147.137.79:8008',
    ...
    def _save_excel(self, goods_list):
        ...
        df.to_excel(excel_writer=writer, columns=['title', 'price', 'location', 'sales','comment_count' ,'comment_url'], index=False,
